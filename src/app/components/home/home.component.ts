...
import { ResumenAlimentosComponent } from "../resumen-alimentos/resumen-alimentos.component";
...
@Component({
    ...
    imports: [ResumenAlimentosComponent, TablaComidasComponent, TabsComidaEjercicioComponent]
})
